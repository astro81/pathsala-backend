...
class HasRatingPermission(BasePermission):
    ...
    1. Add `permission_classes = [HasRatingPermission]` to your view
    ...
    def has_permission(self, request, view):
        ...
        return required_permission == 'rate_course' and has_role(request.user, 'student')
